...
/**
 * Cosa dovrebbe fare questo decoratore della request:
 *
 * 1) Restituire una istanza di Axios
 *    a) Aggiungere il baseUrl (obbligatorio)
 *    b) Aggiunge gli headers di default da proxare (possono essere sovrascritti da una opzione del plugin)
 *    c) Aggiungere tutte le opzioni di Axios (opzionali, se ci sono headers fare merge con punto b)
 *    d) Aggiunge gli interceptor se abilitati dal plugin
 */

/**
 *  Che opzioni dovrebbe prevedere il plugin:
 *
 *  1) Abilitare l'interceptor per i tempi di risposta
 *  2) Abilitare l'interceptor per i log delle richieste e delle risposte
 *  3) Fornire la lista degli headers da proxare se diversa da quella di default
 */
